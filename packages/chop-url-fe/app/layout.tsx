...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || "https://chop-url.vercel.app"),
  title: {
    default: "Chop URL - Modern URL Shortener",
    template: "%s | Chop URL"
  },
  description: "Chop URL is a modern, fast, and secure URL shortener service. Create short, memorable links in seconds.",
  keywords: [
    "url shortener",
    "link shortener",
    "short url",
  ...
  openGraph: {
    ...
    description: "Create short, memorable links in seconds with our modern URL shortener service.",
    siteName: "Chop URL",
    images: [
      {
        url: "/og-image.png",
